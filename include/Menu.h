...
public:
    ...
    //日志展示菜单
    static void showLogMenu(endstone::Player &player, const std::vector<TianyanCore::LogData>& logDatas, const int page = 0) {
        // 计算分页信息
    ...
    //tyback菜单
    static void tybackMenu(endstone::Player &sender) {
